...
int main(int argc, char* argv[]){
    ...
    if (strcmp(argv[1], "pdFW") == 0){
        ...
        para_pdFW.l0Sparsity = 5000;
        para_pdFW.dualSparsity = 8000;
        para_pdFW.delta = 20;
        para_pdFW.eta = 0.5;
        para_pdFW.L = 3;
        //
